...
const WT = {
  A:[
    {day:1,type:"rest",title:"Descanso activo",dur:30,ex:["Movilidad suave 15 min","Paseo opcional"]},
    {day:2,type:"strength",title:"Tren inferior + Aquiles",dur:90,ex:["Excéntricos Alfredson 3×15","Sentadilla búlgara 4×8","Peso muerto rumano 4×10","Hip thrust 3×12","Curl femoral 3×12","Abducción cadera banda 3×15"]},
    ...
    {day:4,type:"strength",title:"Tren superior + lanzamiento",dur:90,ex:["Press banca inclinado 4×8","Dominadas 4×8","Remo barra 4×10","Press militar 3×10","Face pulls 3×15","Lanzamiento técnico 30 min"]},
    ...
    {day:6,type:"strength",title:"Full body + Aquiles",dur:100,ex:["Excéntricos Alfredson 3×15","Sentadilla frontal 4×6","Peso muerto 4×5","Press banca 3×8","Remo 3×10","Farmer carry 3×20m"]},
    {day:7,type:"cardio",title:"Aeróbico largo",dur:105,ex:["Bici/elíptica 90 min Z2","FC 125-140 ppm","Constante y suave"]},
  ],
  B:[
    {day:1,type:"rest",title:"Descanso activo",dur:25,ex:["Movilidad suave","Estiramientos"]},
    {day:2,type:"strength",title:"Tren inferior + Aquiles con lastre",dur:90,ex:["Excéntricos con chaleco 3×12","Sentadilla búlgara 4×8","Peso muerto rumano 4×10","Leg press 4×10","Hip thrust 3×12","Abducción cadera 3×15"]},
    {day:3,type:"cardio",title:"Trote intervalado + core",dur:90,ex:["Trote 2'/caminar 2' ×8","Plancha 4×50seg","Dead bug 3×12","Pallof press 3×10"]},
    {day:4,type:"strength",title:"Tren superior + lanzamiento dinámico",dur:90,ex:["Press banca 4×6","Dominadas lastradas 4×6","Remo pesado 4×8","Lanzamiento + desplazamiento lateral","Hucks con carrerilla suave"]},
    ...
    {day:6,type:"strength",title:"Full body + Aquiles progresivo",dur:100,ex:["Excéntricos con carga 3×12","Sentadilla 4×5","Peso muerto 4×5","Press militar 3×8","Remo polea 3×10","Farmer carry 3×25m"]},
  ...
  C:[
    ...
    {day:2,type:"strength",title:"Potencia tren inferior",dur:90,ex:["Excéntricos mantenimiento 3×10","Sentadilla explosiva 5×3","Box jumps 4×5","Peso muerto 4×4","Hip thrust pesado 3×6","Saltos laterales 3×6/lado"]},
    ...
    {day:4,type:"strength",title:"Tren superior potencia",dur:90,ex:["Press banca explosivo 5×3","Dominadas explosivas 4×5","Push press 4×4","Remo Pendlay 4×6","Rotaciones externas 3×15","Landmine rotation 3×8"]},
    ...
    {day:6,type:"technical",title:"Sprints + drills específicos",dur:100,ex:["Calentamiento 20 min","Sprints 15m ×6","Sprints 20m ×6","Drill in-cut/away-cut 4×4","Lanzamiento variado 20 min","Hucks desde carrera ×10"]},
  ...
  D:[
    ...
    {day:2,type:"strength",title:"Fuerza máxima + Aquiles",dur:90,ex:["Excéntricos mantenimiento 2×10","Sentadilla 5×3 al 85%","Peso muerto 5×3 al 85%","Hip thrust pesado 3×5","Pistol squat asistido 3×5/pierna"]},
    ...
    {day:4,type:"strength",title:"Tren superior + lanzamiento competitivo",dur:90,ex:["Press banca 4×4","Dominadas lastradas 4×5","Remo pesado 4×6","Lanzamientos con viento","Footwork defensivo 4×30s"]},
    ...
    {day:6,type:"technical",title:"Stack + situaciones de partido",dur:100,ex:["Calentamiento completo","Stack vertical: timing de corte","Horizontal stack: espaciado","Endzone plays ensayadas","3v3 espacio reducido"]},
    {day:7,type:"match",title:"Partido / entreno con equipo",dur:120,ex:["Semana 10: 50% tiempo de juego","Semana 11: 70% ritmo casi completo","Semana 12: 100% competitivo","Si Aquiles >4/10 → parar"]},
  ],
};
