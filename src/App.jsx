...
const WT = {
  A:[
    {day:1,type:"strength",title:"Tren inferior + Aquiles",dur:90,ex:["Excéntricos Alfredson 3×15","Sentadilla búlgara 4×8","Peso muerto rumano 4×10","Hip thrust 3×12","Curl femoral 3×12","Abducción cadera banda 3×15"]},
    {day:2,type:"cardio",title:"Aeróbico sin impacto + core",dur:90,ex:["Bici/elíptica 50 min Z2","Plancha frontal 4×45seg","Plancha lateral 3×12","Rollout 3×10","McGill curl-up 3×10"]},
    {day:3,type:"strength",title:"Tren superior + lanzamiento",dur:90,ex:["Press banca inclinado 4×8","Dominadas 4×8","Remo barra 4×10","Press militar 3×10","Face pulls 3×15","Lanzamiento técnico 30 min"]},
    {day:4,type:"mobility",title:"Movilidad + táctica",dur:70,ex:["Foam roller 10 min","Estiramientos 15 min","Propioceptivo tobillo","Visionado vídeos tácticos"]},
    {day:5,type:"strength",title:"Full body + Aquiles",dur:100,ex:["Excéntricos Alfredson 3×15","Sentadilla frontal 4×6","Peso muerto 4×5","Press banca 3×8","Remo 3×10","Farmer carry 3×20m"]},
    {day:6,type:"cardio",title:"Aeróbico largo",dur:105,ex:["Bici/elíptica 90 min Z2","FC 125-140 ppm","Constante y suave"]},
    {day:7,type:"rest",title:"Descanso activo",dur:30,ex:["Movilidad suave 15 min","Paseo opcional"]},
  ],
  B:[
    {day:1,type:"strength",title:"Tren inferior + Aquiles con lastre",dur:90,ex:["Excéntricos con chaleco 3×12","Sentadilla búlgara 4×8","Peso muerto rumano 4×10","Leg press 4×10","Hip thrust 3×12","Abducción cadera 3×15"]},
    {day:2,type:"cardio",title:"Trote intervalado + core",dur:90,ex:["Trote 2'/caminar 2' ×8","Plancha 4×50seg","Dead bug 3×12","Pallof press 3×10"]},
    {day:3,type:"strength",title:"Tren superior + lanzamiento dinámico",dur:90,ex:["Press banca 4×6","Dominadas lastradas 4×6","Remo pesado 4×8","Lanzamiento + desplazamiento lateral","Hucks con carrerilla suave"]},
    {day:4,type:"mobility",title:"Propiocepción + saltos básicos",dur:75,ex:["Foam roller","Saltos bilaterales bajos 3×8","Aterrizaje controlado 3×10","Equilibrio inestable 3×30s"]},
    {day:5,type:"strength",title:"Full body + Aquiles progresivo",dur:100,ex:["Excéntricos con carga 3×12","Sentadilla 4×5","Peso muerto 4×5","Press militar 3×8","Remo polea 3×10","Farmer carry 3×25m"]},
    {day:6,type:"cardio",title:"Fartlek en bici/elíptica",dur:100,ex:["20 min Z1","Intervalos 20s fuerte / 2 min suave ×8","Intervalos 30s fuerte / 90s suave ×6","20 min Z1"]},
    {day:7,type:"rest",title:"Descanso activo",dur:25,ex:["Movilidad suave","Estiramientos"]},
  ],
  C:[
    {day:1,type:"strength",title:"Potencia tren inferior",dur:90,ex:["Excéntricos mantenimiento 3×10","Sentadilla explosiva 5×3","Box jumps 4×5","Peso muerto 4×4","Hip thrust pesado 3×6","Saltos laterales 3×6/lado"]},
    {day:2,type:"technical",title:"Cuts + aceleración + disco",dur:90,ex:["Calentamiento dinámico 15 min","Cuts 45° media intensidad 4×6","Cuts 90° (in-cut) 4×6","Aceleraciones 10m ×8","Lanzamiento con presión temporal"]},
    {day:3,type:"strength",title:"Tren superior potencia",dur:90,ex:["Press banca explosivo 5×3","Dominadas explosivas 4×5","Push press 4×4","Remo Pendlay 4×6","Rotaciones externas 3×15","Landmine rotation 3×8"]},
    {day:4,type:"mobility",title:"Recuperación activa + táctica",dur:70,ex:["Foam roller completo","Movilidad caderas y tobillos","Sombra 1v1 sin disco","Visionado: zone defense, H-stack"]},
    {day:5,type:"technical",title:"Sprints + drills específicos",dur:100,ex:["Calentamiento 20 min","Sprints 15m ×6","Sprints 20m ×6","Drill in-cut/away-cut 4×4","Lanzamiento variado 20 min","Hucks desde carrera ×10"]},
    {day:6,type:"cardio",title:"Intervalos tipo punto Ultimate",dur:90,ex:["Calentamiento 15 min","30s máxima / 90s descanso ×12","15s sprint / 45s descanso ×8","Vuelta calma 15 min"]},
    {day:7,type:"rest",title:"Descanso activo",dur:20,ex:["Movilidad suave","Foam roller si necesario"]},
  ],
  D:[
    {day:1,type:"strength",title:"Fuerza máxima + Aquiles",dur:90,ex:["Excéntricos mantenimiento 2×10","Sentadilla 5×3 al 85%","Peso muerto 5×3 al 85%","Hip thrust pesado 3×5","Pistol squat asistido 3×5/pierna"]},
    {day:2,type:"technical",title:"Cuts explosivos + lanzamiento máximo",dur:100,ex:["Calentamiento completo","Cuts 45° máxima velocidad 4×5","Cuts 90° máxima velocidad 4×5","Sprints 20-30m ×8 arranque variado","Hucks máxima potencia ×10","Break-mark bajo presión (IO, OI, hammer)"]},
    {day:3,type:"strength",title:"Tren superior + lanzamiento competitivo",dur:90,ex:["Press banca 4×4","Dominadas lastradas 4×5","Remo pesado 4×6","Lanzamientos con viento","Footwork defensivo 4×30s"]},
    {day:4,type:"mobility",title:"Recuperación + táctica pre-comp",dur:60,ex:["Movilidad completa","Foam roller","Análisis: set plays, endzone","Visualización pre-partido"]},
    {day:5,type:"technical",title:"Stack + situaciones de partido",dur:100,ex:["Calentamiento completo","Stack vertical: timing de corte","Horizontal stack: espaciado","Endzone plays ensayadas","3v3 espacio reducido"]},
    ...
    {day:7,type:"rest",title:"Descanso completo",dur:0,ex:["Descanso total","Hidratación y nutrición de recuperación"]},
  ],
};
